...
# ============================================================
# 정산 매크로 v92.7 - v89.8 디자인 기반 에러 해결 최종본
# ============================================================
...
def copy_box(text, color_type="blue", box_id="default"):
    ...
    box_height = max(80, line_count * 24 + 65)
    html_code = f"""
    ...
    """
    components.html(html_code, height=box_height, key=f"html_{box_id}")

st.set_page_config(page_title="정산 매크로 v92.7", layout="centered")

# --- v89.8 Noah 실장님 픽 디자인 CSS ---
st.markdown("""
<style>
...
if st.session_state.page == 'settle':
    ...
    c1, c2 = st.columns(2)
    with c1: b_val = extract_int(st.text_input("빗썸 시세", key="b_v", value="0"))
    with c2: s_val = extract_int(st.text_input("수동 환율", key="s_v", value="0"))
    ...
    st.subheader("💳 내 USDT 지갑 주소 (Top-up용)")
